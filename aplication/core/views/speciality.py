...
class SpecialityListView(LoginRequiredMixin,ListViewMixin,ListView):
...
class SpecialityCreateView(LoginRequiredMixin,CreateViewMixin, CreateView):
    model = Especialidad
...
class SpecialityUpdateView(LoginRequiredMixin,UpdateViewMixin,UpdateView):
    model = Especialidad
    template_name = 'core/speciality/form.html'
    form_class = SpecialityForm
    success_url = reverse_lazy('core:speciality_list')
...
class SpecialityDeleteView(LoginRequiredMixin,DeleteViewMixin,DeleteView):
    model = Especialidad
    success_url = reverse_lazy('core:speciality_list')
...
class SpecialityDetailView(LoginRequiredMixin,DetailView):
    model = Especialidad
