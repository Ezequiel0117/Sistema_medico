...
class BtypeListView(LoginRequiredMixin,ListViewMixin,ListView):
...
class BtypeCreateView(LoginRequiredMixin,CreateViewMixin, CreateView):
    model = TipoSangre
...
class BtypeUpdateView(LoginRequiredMixin,UpdateViewMixin,UpdateView):
    model = TipoSangre
    template_name = 'core/BloodType/form.html'
    form_class = BtypeForm
    success_url = reverse_lazy('core:type_list')
...
class BtypeDeleteView(LoginRequiredMixin,DeleteViewMixin,DeleteView):
    model = TipoSangre
